...
def preprocess_xray_directory(src_path, dst_path):
    ...
    for file_name in os.listdir(src_path):
        ...
        xray_file = file_path + f'/{file_name}.npy'
...
if __name__ == "__main__":
    ...
    src_path = "/teamspace/studios/this_studio/Xray2Dnpy"
    dst_path = "/teamspace/studios/this_studio/datasets/XRay_preprocessed_224_224/"
