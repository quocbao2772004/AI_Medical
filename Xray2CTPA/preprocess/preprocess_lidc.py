...
def convert_dicom_directories_to_numpy(src_path, dst_path_vae, dst_path_py, vae):
    ...
    for pid in sorted(os.listdir(src_path)):
...
if __name__ == "__main__":
    ...
    src_path = "/teamspace/studios/this_studio/Filter/LIDC_IDRI"
    dst_path_vae = "/teamspace/studios/this_studio/datasets/lidc_vae_256/"
    dst_path = "/teamspace/studios/this_studio/datasets/lidc_256/"
